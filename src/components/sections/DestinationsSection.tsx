            ...
            {items?.map((dest, i) => (
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden">
                  <img
                    src={dest.image}
                    alt={lang === 'fr' ? dest.name_fr : dest.name_en}
                    loading="lazy"
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-6 text-white">
                    <h3 className="font-display text-2xl font-bold drop-shadow-lg">{lang === 'fr' ? dest.name_fr : dest.name_en}</h3>
                    <p className="mt-1 line-clamp-2 text-sm text-white/80">{lang === 'fr' ? dest.desc_fr : dest.desc_en}</p>
                    <Link
                      to="/destinations"
